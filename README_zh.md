...
*   **Go**
    ...
    *  🌟 [a2a-go](https://github.com/yeeaiclub/a2a-go) by [@yeeaiclub](https://github.com/yeeaiclub) [![Stars](https://img.shields.io/github/stars/yeeaiclub/a2a-go?style=social)](https://github.com/yeeaiclub/a2a-go) - 参考谷歌官方的 a2a-python 实现的 go 版本，支持a2a 协议的各种方法 。
...
*   🌟 [A2AApp](https://github.com/tanaikech/A2AApp) by [@tanaikech](https://github.com/tanaikech) [![Stars](https://img.shields.io/github/stars/tanaikech/A2AApp?style=social)](https://github.com/tanaikech/A2AApp) - 一个基于 Google Apps Script 构建的 Agent2Agent (A2A) 网络，可在 Google Workspace 中同时作为 A2A 服务器和客户端，实现安全、去中心化的 AI 通信与集成。

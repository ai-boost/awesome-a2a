...
*   **JavaScript/TypeScript**
    ...
    *   🌟 [vaultfire-a2a](https://github.com/Ghostkey316/vaultfire-a2a) by [@Ghostkey316](https://github.com/Ghostkey316) [![Stars](https://img.shields.io/github/stars/Ghostkey316/vaultfire-a2a?style=social)](https://github.com/Ghostkey316/vaultfire-a2a) - TypeScript A2A trust extension for AI agents. Adds onchain identity (ERC-8004), reputation, and accountability bonds to A2A AgentCards across Base, Avalanche, Arbitrum, and Polygon. Published on npm as `@vaultfire/a2a`. Live spec proposal in [a2aproject/A2A#1804](https://github.com/a2aproject/A2A/issues/1804).
*   **PHP**

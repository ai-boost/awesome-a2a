...
- [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) - Multi-agent orchestrator with A2A and MCP protocol support. Spawns parallel AI coding agents, manages task lifecycle, quality gates.

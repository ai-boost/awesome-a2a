...
*   **Security**
    ...
    *   🔐 [@vorim/a2a](https://github.com/Kzino/vorim-ai) by [@Kzino](https://github.com/Kzino) [![Stars](https://img.shields.io/github/stars/Kzino/vorim-ai?style=social)](https://github.com/Kzino/vorim-ai) - Identity and trust verification layer for A2A Agent Cards. Extends Agent Cards with Ed25519 cryptographic identity, live trust scoring (0-100), and permission verification. TypeScript ([npm](https://www.npmjs.com/package/@vorim/a2a)) + Python ([PyPI](https://pypi.org/project/vorim/)).

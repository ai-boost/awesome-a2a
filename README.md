...
*   🌟 [AgentLux](https://agentlux.ai) - Identity, marketplace, and services platform for AI agents on Base L2. Features an agent-to-agent services marketplace with escrow, x402 micropayments, ERC-8004 on-chain identity, and 32+ MCP tools for autonomous agent interaction.

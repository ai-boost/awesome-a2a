...
*   🌟 [Human Pages](https://humanpages.ai) by [@human-pages-ai](https://github.com/human-pages-ai) [![Stars](https://img.shields.io/github/stars/human-pages-ai/humanpages?style=social)](https://github.com/human-pages-ai/humanpages) - MCP server that gives AI agents access to real-world people who listed themselves to be hired by agents. 31 tools for search, job offers, messaging, and payments.

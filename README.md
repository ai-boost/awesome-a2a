...
*   🌐 [ClawNet](https://clwnt.com) by [@ethanbeard](https://github.com/ethanbeard) - Hosted A2A endpoints for any agent. Register once, get a permanent A2A address with store-and-forward task queuing, email (@clwnt.com), agent cards, and a public directory. No server deployment required. Try it: `curl -X POST https://api.clwnt.com/a2a/Gateway`.

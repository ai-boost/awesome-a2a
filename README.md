...
*   🌟 [SwarmTrade](https://github.com/tjcrowley/a2a-hub) by [@tjcrowley](https://github.com/tjcrowley) [![Stars](https://img.shields.io/github/stars/tjcrowley/a2a-hub?style=social)](https://github.com/tjcrowley/a2a-hub) - Agent-to-agent marketplace with escrow, negotiation, and reputation, supporting both off-chain and on-chain (EVM) settlement.

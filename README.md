...
*   🌟 [SILT AI Playground](https://github.com/izabael/ai-playground) by [@izabael](https://github.com/izabael) [![Stars](https://img.shields.io/github/stars/izabael/ai-playground?style=social)](https://github.com/izabael/ai-playground) - An open-source social platform where AI agents register via A2A Agent Cards and interact in shared channels, BBSes, DMs, and federated instances. Implements the A2A v0.3 schema with a custom `playground/persona` extension namespace for structured personality (voice, values, aesthetic, origin). FastAPI + SQLite, Apache 2.0. Live flagship instance at [izabael.com](https://izabael.com).

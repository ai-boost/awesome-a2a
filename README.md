...
*   **Rust**
    ...
    *   🌟 [rust-adk](https://github.com/inference-gateway/rust-adk) by [@edenreich](https://github.com/edenreich) [![Stars](https://img.shields.io/github/stars/inference-gateway/rust-adk?style=social)](https://github.com/inference-gateway/rust-adk) - An Agent Development Kit (ADK) allowing for seamless creation of A2A-compatible agents written in Rust.

...
*   🌟 [Chat Agent Relay (CAR)](https://github.com/ChatAgentRelay/ChatAgentRelay) by [@ChatAgentRelay](https://github.com/ChatAgentRelay) [![Stars](https://img.shields.io/github/stars/ChatAgentRelay/ChatAgentRelay?style=social)](https://github.com/ChatAgentRelay/ChatAgentRelay) - A relay layer between chat platforms and A2A agents that normalizes messages into canonical events and adds routing, governance, delivery retry, replay, and append-only audit across Slack, Teams, Discord, Telegram, WhatsApp, Lark, DingTalk, and WebChat.

...
*   🌟 [PolicyCheck](https://legaleasy.tools/.well-known/agent.json) by [@vibegpt](https://github.com/vibegpt) - Pre-purchase seller policy analysis agent for AI purchasing agents. Analyzes return policies, shipping, warranty, and terms of service to assess buyer protection risk. Live hosted service with JSON-RPC 2.0 A2A endpoint, also available via MCP and x402 micropayments.

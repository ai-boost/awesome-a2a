...
*   🌟 [mq9](https://github.com/robustmq/mq9) by [@robustmq](https://github.com/robustmq) [![Stars](https://img.shields.io/github/stars/robustmq/mq9?style=social)](https://github.com/robustmq/mq9) - Purpose-built messaging broker for multi-agent systems and native A2A transport. Provides a built-in agent registry with full-text and semantic vector discovery, per-agent persistent mailboxes (messages wait until the recipient comes online), 3-tier priority (critical/urgent/normal), and FETCH+ACK pull consumption — registry and reliable async messaging unified in one broker. The `mq9.a2a` SDK facade wraps the official `a2a-sdk` for A2A-compliant agents in Python and Java. SDKs for Python, Java, Go, Rust, and JavaScript; LangChain/LangGraph toolkit included. Built as the fifth native protocol of [RobustMQ](https://github.com/robustmq/robustmq).

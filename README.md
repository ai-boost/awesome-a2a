...
*   **JavaScript/TypeScript**
    ...
    *   🌟 [@voidly/agent-sdk](https://www.npmjs.com/package/@voidly/agent-sdk) by [@EmperorMew](https://github.com/EmperorMew) - End-to-end encrypted agent communication SDK with A2A v0.3 Agent Card support. Features Double Ratchet (Signal-style forward secrecy), X3DH async key agreement, ML-KEM-768 post-quantum hybrid (NIST FIPS 203), deniable auth, sealed sender, multi-relay failover, offline queue, and federation. Public Agent Card at `https://api.voidly.ai/.well-known/agent-card.json`. `npm i @voidly/agent-sdk`.
*   **PHP**

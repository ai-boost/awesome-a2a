...
*   💸 [Voidly Pay](https://github.com/voidly-ai/voidly-pay) by [@voidly-ai](https://github.com/voidly-ai) [![Stars](https://img.shields.io/github/stars/voidly-ai/voidly-pay?style=social)](https://github.com/voidly-ai/voidly-pay) - A2A payment rail and x402 facilitator. Serves a Google A2A v0.3.0-compatible Agent Card at `/.well-known/agent-card.json`. Supports transfers, escrow, streams, subscriptions, batch payouts, and a marketplace of 17 paid endpoints. USDC settlement on Base via Sourcify-verified vault. Free 10-credit faucet at /pay/claim.

...
*   🌟 [SynapBus](https://github.com/synapbus/synapbus) by [@synapbus](https://github.com/synapbus) [![Stars](https://img.shields.io/github/stars/synapbus/synapbus?style=social)](https://github.com/synapbus/synapbus) - MCP-native agent-to-agent messaging hub with channels, DMs, semantic search (HNSW), task auction, capability discovery, and Slack-like web UI. Single Go binary.

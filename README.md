...
*   🌟 [WritBase](https://github.com/Writbase/writbase) by [@Writbase](https://github.com/Writbase) [![Stars](https://img.shields.io/github/stars/Writbase/writbase?style=social)](https://github.com/Writbase/writbase) - MCP-native task management for AI agent fleets with multi-agent permissions, full provenance, inter-agent delegation, and A2A status mapping.

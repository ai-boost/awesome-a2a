...
*   🌟 [swarm.at](https://github.com/Mediaeater/swarm.at) by [@Mediaeater](https://github.com/Mediaeater) [![Stars](https://img.shields.io/github/stars/Mediaeater/swarm.at?style=social)](https://github.com/Mediaeater/swarm.at) - Git-native settlement protocol for AI agent swarms. Validates actions against institutional rules, settles to a hash-chained ledger, and manages trust-tiered agent identities. Includes MCP server, Python SDK, and workflow blueprints.

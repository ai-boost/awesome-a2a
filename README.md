...
*   🌟 [swarm.at](https://github.com/Mediaeater/swarm-at-ledger) by [@Mediaeater](https://github.com/Mediaeater) [![Stars](https://img.shields.io/github/stars/Mediaeater/swarm-at-ledger?style=social)](https://github.com/Mediaeater/swarm-at-ledger) - Settlement protocol that validates agent actions before execution. Guards destructive operations with hash-chained ledger receipts, trust tiers, and 31 workflow blueprints. Live A2A agent card with 11 skills, MCP server, and Python SDK.

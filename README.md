...
*   🌟 [Vorim AI](https://vorim.ai) by [@Kzino](https://github.com/Kzino) [![Stars](https://img.shields.io/github/stars/Kzino/vorim-protocol?style=social)](https://github.com/Kzino/vorim-protocol) - Identity and trust layer for AI agents. Ed25519 cryptographic identity, scoped permissions, and signed audit trails. 9 framework integrations including A2A. IETF Internet-Draft filed. [GitHub](https://github.com/Kzino/vorim-protocol) | [npm](https://www.npmjs.com/package/@vorim/sdk) | [PyPI](https://pypi.org/project/vorim/)

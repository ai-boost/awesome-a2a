...
*   🌐 [EventTrader NEXUS AI](https://cymetica.com) by [@eventtrader](https://github.com/eventtrader) - AI prediction market trading platform with native A2A protocol support. Features 50+ MCP tools, inter-agent DM infrastructure, autonomous trade execution, and real-time market intelligence. Agent Card at `/.well-known/agent-card.json`, SSE transport, multi-platform bridge federation (IronClaw, NanoClaw, ClawGig).

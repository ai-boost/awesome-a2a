...
*   🌟 [a2a-client-hub](https://github.com/liujuanjuan1984/a2a-client-hub) by [@liujuanjuan1984](https://github.com/liujuanjuan1984) [![Stars](https://img.shields.io/github/stars/liujuanjuan1984/a2a-client-hub?style=social)](https://github.com/liujuanjuan1984/a2a-client-hub) - A self-hosted, multi-tenant A2A client hub for managing, invoking, and operating multiple A2A agents from web/mobile frontends.
*   🌟 [opencode-a2a-server](https://github.com/Intelligent-Internet/opencode-a2a-server) by [@Intelligent-Internet](https://github.com/Intelligent-Internet) [![Stars](https://img.shields.io/github/stars/Intelligent-Internet/opencode-a2a-server?style=social)](https://github.com/Intelligent-Internet/opencode-a2a-server) - A production-oriented A2A server adapter that exposes OpenCode through an Agent2Agent-compatible interface, supporting task orchestration and workflow execution.
*   🌟 [codex-a2a-server](https://github.com/liujuanjuan1984/codex-a2a-server) by [@liujuanjuan1984](https://github.com/liujuanjuan1984) [![Stars](https://img.shields.io/github/stars/liujuanjuan1984/codex-a2a-server?style=social)](https://github.com/liujuanjuan1984/codex-a2a-server) - A2A server bridge for Codex with structured session, artifact, and task lifecycle handling for downstream orchestration.

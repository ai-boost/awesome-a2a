...
*  🌟 [NEXUS](https://github.com/Francosimon53/nexus) by [@Francosimon53](https://github.com/Francosimon53) — The Agent Economy Protocol. Open-source A2A marketplace where agents discover, coordinate, and transact. TypeScript SDK on npm (`@nexus-protocol/sdk`), credit billing, trust scores, and OpenClaw adapter. Built on A2A + MCP.

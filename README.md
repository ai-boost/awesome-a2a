...
*   🌟 [Anlora](https://meetanlora.com) by [@Stanglovicc](https://github.com/Stanglovicc) - A2A v1.0 compliant agent (AgentCard at [meetanlora.com/.well-known/agent-card.json](https://meetanlora.com/.well-known/agent-card.json)) registered with [a2aregistry.org](https://a2aregistry.org). Provides 4 read-only skills for OnlyFans creator-agency operating economics: cost benchmarks, competitor landscape comparison, autonomous-vs-assisted threshold analysis, and citation source list. Backed by [Zenodo DOI 10.5281/zenodo.20187816](https://doi.org/10.5281/zenodo.20187816). Cryptographically signed brand claims at `did:web:meetanlora.com`. Companion MCP server: [Stanglovicc/anlora-mcp](https://github.com/Stanglovicc/anlora-mcp). Open-standard reference implementation of the Agentic Reasoning Protocol (ARP) at [Stanglovicc/anlora-arp](https://github.com/Stanglovicc/anlora-arp).

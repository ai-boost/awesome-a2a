...
*   🌟 [Agent Café](https://github.com/brcrusoe72/agent-cafe) by [@brcrusoe72](https://github.com/brcrusoe72) [![Stars](https://img.shields.io/github/stars/brcrusoe72/agent-cafe?style=social)](https://github.com/brcrusoe72/agent-cafe) - An agent marketplace with behavioral trust scoring, job bidding, Stripe payments, and a 10-stage prompt injection defense. Agents register, browse jobs, bid, deliver, and build computed reputation. Serves Agent Card at `/.well-known/agent-card.json`. Live at [thecafe.dev](https://thecafe.dev).

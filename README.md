...
*   **Python**
    ...
    *   🌟 [codex-a2a-server](https://github.com/liujuanjuan1984/codex-a2a-server) by [@liujuanjuan1984](https://github.com/liujuanjuan1984) [![Stars](https://img.shields.io/github/stars/liujuanjuan1984/codex-a2a-server?style=social)](https://github.com/liujuanjuan1984/codex-a2a-server) - Turn Codex CLI into a stateful, production-oriented A2A agent service with standardized transport and lifecycle mapping.
    *   🌟 [opencode-a2a-server](https://github.com/Intelligent-Internet/opencode-a2a-server) by [@Intelligent-Internet](https://github.com/Intelligent-Internet) [![Stars](https://img.shields.io/github/stars/Intelligent-Internet/opencode-a2a-server?style=social)](https://github.com/Intelligent-Internet/opencode-a2a-server) - Turn OpenCode into a stateful A2A service with production-friendly deployment, auth, and session continuity.
*   **C#/.NET**

...
*   🌟 [TIAMAT](https://github.com/toxfox69/tiamat-entity) by [@toxfox69](https://github.com/toxfox69) [![Stars](https://img.shields.io/github/stars/toxfox69/tiamat-entity?style=social)](https://github.com/toxfox69/tiamat-entity) - An autonomous AI agent running 24/7 with A2A-compliant discovery at [tiamat.live/.well-known/agent.json](https://tiamat.live/.well-known/agent.json). Offers summarization, streaming chat, algorithmic image generation, and text-to-speech services with x402 USDC micropayments on Base. Built by ENERGENAI LLC.

...
*   🌟 [Suwappu](https://github.com/0xSoftBoi/suwappubot) by [@0xSoftBoi](https://github.com/0xSoftBoi) [![Stars](https://img.shields.io/github/stars/0xSoftBoi/suwappubot?style=social)](https://github.com/0xSoftBoi/suwappubot) - Cross-chain DEX for AI agents with A2A protocol support. Swap tokens, get quotes, and check portfolio across 7+ chains (Ethereum, Base, Arbitrum, Polygon, BSC, Optimism, Solana). Also available as an MCP server.

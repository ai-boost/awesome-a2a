...
*   🌟 [Tiny Marten / aibtc.news](https://aibtc.news) — Bitcoin-native autonomous agent with [A2A Agent Card](https://publisher-note.p-d07.workers.dev/.well-known/agent.json). Skills: Agent Intelligence (x402 micropayments), Bounty Board, Signal Filing, Classifieds, Ordinals Order Book. 147 agents earning BTC via cryptographically signed intelligence inscribed on Bitcoin.

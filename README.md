...
*   🌟 [OpenAgents](https://github.com/openagents-org/openagents) by [@openagents-org](https://github.com/openagents-org) [![Stars](https://img.shields.io/github/stars/openagents-org/openagents?style=social)](https://github.com/openagents-org/openagents) - Open-source platform for building AI agent networks where multiple agents connect, communicate, and collaborate. Natively supports A2A, MCP, WebSocket, gRPC, and HTTP protocols.

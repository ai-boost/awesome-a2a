...
*   **JavaScript/TypeScript**
    ...
    *   🌟 [Artinet SDK](https://github.com/the-artinet-project/artinet-sdk) by [@the-artinet-project](https://github.com/the-artinet-project) - Agent2Agent (A2A) プロトコルに準拠した TypeScript (node.js) 製のサーバーおよびクライアントで、相互運用可能な AI エージェントの作成を簡素化します。Google のサンプルを大幅に強化し、開発者エクスペリエンス、信頼性、包括的な機能に重点を置いた本番環境対応ソリューションを提供します。[artinet project で詳細を見る](https://www.artinet.com/)。
*   **Java**

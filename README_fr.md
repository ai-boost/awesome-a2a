...
*   **JavaScript/TypeScript**
    ...
    *   🌟 [Artinet SDK](https://github.com/the-artinet-project/artinet-sdk) by [@the-artinet-project](https://github.com/the-artinet-project) - Un serveur et client conformes au protocole Agent2Agent (A2A) écrits en TypeScript pour node.js, visant à simplifier la création d'agents IA interopérables. Améliore considérablement les exemples de Google, offrant une solution prête pour la production axée sur l'expérience développeur, la fiabilité et des fonctionnalités complètes. [En savoir plus sur le projet artinet](https://www.artinet.com/).
*   **Java**
...
*   **Outil de Validation A2A**
    *   ⚙️ [A2A Validation Tool](https://github.com/llmx-de/a2a-validation-tool) by [@llmx-de](https://github.com/llmx-de) - Une application de bureau pour tester et valider les implémentations du protocole A2A. Elle prend en charge les connexions multi-agents, l'inspection des cartes d'agent, le streaming, la gestion des sessions, les pièces jointes, la visualisation JSON, l'import/export de configurations et est multiplateforme.

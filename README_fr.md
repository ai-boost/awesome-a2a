...
*   **Go**
    ...
    *  🌟 [a2a-go](https://github.com/yeeaiclub/a2a-go) by [@yeeaiclub](https://github.com/yeeaiclub) [![Stars](https://img.shields.io/github/stars/yeeaiclub/a2a-go?style=social)](https://github.com/yeeaiclub/a2a-go) - Implémentation du protocole Agent-to-Agent pour Go, prenant entièrement en charge toutes les méthodes du protocole A2A et s'appuyant sur l'implémentation officielle du SDK Python. 
*   **Rust**
...
*   🌟 [A2AApp](https://github.com/tanaikech/A2AApp) by [@tanaikech](https://github.com/tanaikech) [![Stars](https://img.shields.io/github/stars/tanaikech/A2AApp?style=social)](https://github.com/tanaikech/A2AApp) - Un réseau Agent2Agent (A2A) construit avec Google Apps Script, permettant une communication et une intégration IA sécurisées et décentralisées au sein de Google Workspace, agissant à la fois comme serveur et client A2A.

...
*   **JavaScript/TypeScript**
    ...
    *   🌟 [Artinet SDK](https://github.com/the-artinet-project/artinet-sdk) by [@the-artinet-project](https://github.com/the-artinet-project) - Un servidor y cliente compatible con el Protocolo Agent2Agent (A2A) escrito en TypeScript para node.js, que simplifica la creación de agentes de IA interoperables. Mejora significativamente los ejemplos de Google, ofreciendo una solución lista para producción con un enfoque en la experiencia del desarrollador, la fiabilidad y características completas. [Más información en el proyecto artinet](https://www.artinet.com/).
*   **Java**
...
*   **Herramienta de Validación A2A**
    *   ⚙️ [A2A Validation Tool](https://github.com/llmx-de/a2a-validation-tool) by [@llmx-de](https://github.com/llmx-de) - Una aplicación de escritorio para probar y validar implementaciones del protocolo A2A. Admite conexiones multiagente, inspección de tarjetas de agente, streaming, gestión de sesiones, archivos adjuntos, visualización JSON, importación/exportación de configuraciones y es multiplataforma.
